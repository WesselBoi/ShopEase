    ...
    <div className="min-h-screen bg-gradient-to-br from-purpleBg to-darkerBg py-12 px-4">
      <div className="max-w-2xl mx-auto">
        ...
        <div className="text-center mb-8">
          <h1 className="text-4xl font-bold text-goldish mb-2">Payment Method</h1>
          <p className="text-white opacity-75">Choose your preferred payment option</p>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-2xl p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="space-y-3">
              <h3 className="text-lg font-semibold text-darkerBg mb-4">Select Payment Method</h3>
                ...
                >
                  ...
                  <div className="flex-1">
                    <div className="flex items-center">
                      ...
                      <div>
                        <div className="flex items-center">
                          <span className="font-medium text-darkerBg">{option.name}</span>
                          {option.popular && (
