    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-purpleBg to-darkerBg flex items-center justify-center">
        <div className="text-center">
          ...
          <h2 className="text-2xl text-white font-semibold">Loading your orders...</h2>
        </div>
      </div>
    );
  }
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-purpleBg to-darkerBg flex items-center justify-center">
        <div className="text-center text-white">
          ...
          <p className="mb-4 opacity-75">{error?.data?.error || 'Something went wrong'}</p>
          <button 
      ...
      <div className="max-w-7xl mx-auto">
        ...
        {!myOrders || myOrders.length === 0 ? (
          <div className="bg-white rounded-2xl shadow-lg p-12 text-center">
            ...
            <h3 className="text-2xl font-bold text-darkerBg mb-4">No Orders Yet</h3>
                  ...
                  <div className="space-y-3">
                    {order.orderItems?.slice(0, 3).map((item, index) => (
                      <div key={index} className="flex items-center justify-between">
                        <div className="flex items-center">
                          ...
                          <div>
                            <div className="font-medium text-darkerBg">{item.name}</div>
                    ...
                    {(order.orderItems?.length || 0) > 3 && (
                      <div className="text-center text-gray-500 text-sm">
                        and {(order.orderItems?.length || 0) - 3} more item{(order.orderItems?.length || 0) - 3 !== 1 ? 's' : ''}...
                      </div>
                    )}
                  </div>
                </div>
